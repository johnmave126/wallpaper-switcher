    ...
    render() {
        return (
            <div className="body">
                ...
                <p>A small utility to manage wallpapers across multiple monitors on Windows written by <ExtLink href="mailto:johnmave126@gmail.com" title="johnmave126@gmail.com">Shuhao Tan</ExtLink>. Licensed under <ExtLink href="http://">MIT</ExtLink>.</p>
